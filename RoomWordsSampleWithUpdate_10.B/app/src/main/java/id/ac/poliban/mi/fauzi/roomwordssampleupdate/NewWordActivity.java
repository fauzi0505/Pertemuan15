package id.ac.poliban.mi.fauzi.roomwordssampleupdate;


import static id.ac.poliban.mi.fauzi.roomwordssampleupdate.MainActivity.EXTRA_DATA_ID;
import static id.ac.poliban.mi.fauzi.roomwordssampleupdate.MainActivity.EXTRA_DATA_UPDATE_WORD;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.mi.fauzi.roomwordssampleupdate.REPLY";
    public static final String EXTRA_REPLY_ID = "id.ac.poliban.mi.fauzi.roomwordssampleupdate.REPLY_ID";
